...
const PROGRESS_UPDATE_MESSAGES = {
  employer_review: 'Your profile is now being reviewed by the employer for this role.',
  interview_scheduled: 'Your interview has been scheduled. The employer will share the time and meeting details with you shortly.',
  job_offer: 'Your job offer has been issued. Please review the offer and employment contract carefully before signing.',
  visa_processing: 'Your visa is now being processed. Your employer has submitted the Qatar work visa application on your behalf. We will update you when there is progress.',
  visa_approved: 'Your Qatar work visa has been approved. Your entry permit and next travel instructions will be shared with you.',
  flight_prep: 'Your flight preparation is now underway. Your employer or agency will confirm your travel arrangements with you.',
  arrived: 'You have been marked as arrived in Qatar. Your employer will guide you through onboarding and required registrations.',
  employed: 'Your employment has started. Welcome to your new role in Qatar!',
  rejected: 'Your application was not selected for this opportunity. FindAJob.qa wishes you success with your next application.',
  cancelled: 'This application has been cancelled. Please contact FindAJob.qa if you believe this was a mistake.',
};
...
async function insertProgressUpdateMessage(applicationId, status, senderRole, senderName, senderEmail, comment) {
  const message = PROGRESS_UPDATE_MESSAGES[status];
  if (!message) return;
